 ...
 * READER
 *****************************************************************************/
/** Status code used when parsing messages */
enum tbcm_360_3000_he_dri_reader_status_code
{
	/** Message has been processed */
	TBCM_360_3000_HE_DRI_READER_STATUS_CODE_OK,

	/** Message can't be processed, until previous one is processed */
	TBCM_360_3000_HE_DRI_READER_STATUS_CODE_BUSY,

	/** Message is not valid */
	TBCM_360_3000_HE_DRI_READER_STATUS_CODE_INVALID
};
 ...
 *  Returns false if busy, frame does not belong to device or invalid.
 */
